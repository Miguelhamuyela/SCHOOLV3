...
@section('content')
    ...
    <div class="card mb-2">
        <div class="card-body">
            <h2 class="h5 page-title"><b>
                    <a href="{{ url('admin/solicitacao/list') }}">Listar Funcionários</a>
                    > Detalhes de Funcionários - {{ $solicitions->name }}
                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <p class="text-dark">
                            ...
                            @else
                                <small>
                                    <img src="/storage/{{$solicitions->photoEmployee}}"
                                        class="mr-2 rounded-circle img-fluid" alt="Cinque Terre" width="90" height="90">
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <small class="mb-1 text-dark">
                            ...
                            {{ $solicitions->created_at }}
                        </small><br>
                        <small class="mb-1 text-dark">
                            <b>Última Actualização:</b>
                            {{ $solicitions->updated_at }}
                        </small>
                    </div>
                    <div class="col-md-4 text-dark text-right">
                        <a type="button" class="btn btn-primary text-left text-white mb-2 btn-fw"
                            href='{{ url("admin/solicitacao/edit/{$solicitions->id}") }}'>
    ...
    @include('admin.extras.modal.delete.solicitions.index')
@endsection
